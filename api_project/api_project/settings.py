...
SECRET_KEY = 'django-insecure-inp6#sw_se6qi1-jnz3m)=qxq$ai&1#)0_tv-6vw^t+cf+0$2#'
...
REST_FRAMEWORK = {
    'DEFAULT_AUTHENTICATION_CLASSES': [
        ...
        'rest_framework.authentication.SessionAuthentication',  # ✅ Allows session-based authentication (optional)
    ],
